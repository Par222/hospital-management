const Tags=()=>{
    ...
    return(
        <div className="px-5 py-2 shadow-md  w-[30%] h-fit ">
            ...
            <div className="flex flex-wrap  w-full my-5">
                {tags.length>0 && tags.map((tag)=><div className="border border-tertiarygrey-500 flex justify-center items-center font-display py-2 w-[32%] mr-1 mb-3 ">{tag}</div>)}
            </div>
