...
const LoginForm = (props) => {
  ...
  return (
    <div className="rounded-md shadow-lg bg-white w-[70%] ">
     ...
     {isLogin && <p className="text-blue-400 font-semibold text-sm mt-1 mb-3 ml-[25%] font-sans w-full cursor-pointer" onClick={()=>setisLogin(false)}>Don't have an Account ?</p>}
    </div>
  );
};
